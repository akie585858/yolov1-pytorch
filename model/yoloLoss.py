...
class yoloLoss(nn.Module):
    ...
    def forward(self,pred_tensor,target_tensor):
        ...
        noo_pred_mask = torch.zeros_like(noo_pred, dtype=torch.bool, device='cuda')
        ...
        coo_response_mask = torch.zeros_like(box_target, dtype=torch.bool, device='cuda')
        coo_not_response_mask = torch.zeros_like(box_target, dtype=torch.bool, device='cuda')
